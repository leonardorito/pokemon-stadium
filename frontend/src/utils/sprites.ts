...
export function animatedSpriteUrl(pokemonId: number, view: SpriteView = 'front'): string | null {
  if (!Number.isFinite(pokemonId) || pokemonId < 1 || pokemonId > GEN_V_MAX) return null;
